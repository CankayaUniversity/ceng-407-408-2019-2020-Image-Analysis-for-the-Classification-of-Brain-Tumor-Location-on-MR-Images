...
--
-- Host: 127.0.0.1    Database: braintumor
-- ------------------------------------------------------
...
CREATE TABLE `original` (
  ...
  `image` blob,
  `isTumor` int DEFAULT NULL,
  `isCancerous` int DEFAULT NULL,
  `left-right` int DEFAULT NULL,
  PRIMARY KEY (`id`)
...
-- Dump completed on 2020-04-30 22:04:19
